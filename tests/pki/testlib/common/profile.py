...
class Policy(object):
    ...
    @classmethod
    def validity_default(cls, root, policy_set_element, default_range, range_value):
    ...
    def netscape_certificate_type_extension_default(cls, root, policy_set_element, extlist):
        ...
        if not result:
            ...
            # Constraints
            Constraint.noConstraintImpl(Policy_Value)
        else:
            Policy_Value = Common.get_element_policy_value(
                policy_set_element, javaclass)
            for v in extlist:
...
class Setup(object):
    ...
    def generate_profile_parameters(self, user_params=None):
        ...
        if self.profile_type in ('user', 'smime'):
            ...
            if user_params['PathLength']:
                profile_input['PathLength'] = user_params['PathLength']
            else:
    ...
    def edit_profile(self, user_params):
        ...
        if 'MaxValidity' in user_params and 'ValidFor' in user_params:
